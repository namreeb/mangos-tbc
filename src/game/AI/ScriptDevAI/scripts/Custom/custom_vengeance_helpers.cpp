...
const std::vector<uint32> Lvl70BiS_ShamanResto          = { 32524, 31016, 30873, 32528, 32238, 32275, 31012, 31019, 32370, 31022, 32258, 30869, 32500, 30882, 32496, 30619, 32344, 30023, 5175, 5176, 5177, 5178 };
const std::vector<uint32> Lvl70BiS_ShamanEnhancement    = { 32323, 34912, 32510, 32497, 32335, 32234, 32376, 30900, 32260, 31024, 32346, 30864, 32946, 32945, 28830, 32505, 32332, 27815, 5175, 5176, 5177, 5178 };
const std::vector<uint32> Lvl70BiS_ShamanElemental      = { 32331, 31017, 32242, 32527, 32247, 31008, 31014, 31020, 32349, 31023, 30044, 32259, 34009, 30872, 32483, 30626, 32374, 32330, 5175, 5176, 5177, 5178 };
